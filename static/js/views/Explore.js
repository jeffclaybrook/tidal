      ...
      return `
         <section>
            <div class="heading">
               <h2>Featured</h2>
               <div class="flex">
                  <button class="icon-btn"><img src="/static/icons/chevron_left.svg" alt="Icon"></button>
                  <button class="icon-btn"><img src="/static/icons/chevron_right.svg" alt="Icon"></button>
               </div>
            </div>
